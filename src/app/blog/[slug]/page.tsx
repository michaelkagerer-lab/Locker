    ...
    <>
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
            ...
            <div className="flex flex-wrap gap-1.5 mt-6">
              {post.tags.map((tag) => (
                <Link
                  ...
                  className="px-2.5 py-0.5 text-xs rounded-full border border-line text-subtle hover:text-main hover:border-[var(--text-muted)] transition-colors"
                >
                  {tag}
                </Link>
              ))}
        ...
        <article className="prose prose-base max-w-none">
          {/* @ts-expect-error -- rehype-pretty-code plugin types */}
